...
export class AddTypeActionsReport1700926593374 implements MigrationInterface {
  name = 'AddTypeActionsReport1700926593374'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`report\` ADD \`type\` enum ('POST', 'COMMENT') NOT NULL`,
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`report\` DROP COLUMN \`type\``)
  }
}
