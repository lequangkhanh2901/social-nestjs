...
export class AddCascadeAvatarId1695638233739 implements MigrationInterface {
  name = 'AddCascadeAvatarId1695638233739'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`IDX_f9053cc87d5bb754cbc6f61953\` ON \`users\``,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_f9053cc87d5bb754cbc6f61953\` ON \`users\` (\`avatarIdId\`)`,
    )
  }
}
