...
export class AvatarForGroupChat1699777722245 implements MigrationInterface {
  name = 'AvatarForGroupChat1699777722245'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`conversation\` ADD \`name\` varchar(30) NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE \`conversation\` ADD \`avatarId\` varchar(36) NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE \`conversation\` ADD UNIQUE INDEX \`IDX_3cdae851f0b12baae5d6c715f6\` (\`avatarId\`)`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_3cdae851f0b12baae5d6c715f6\` ON \`conversation\` (\`avatarId\`)`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`conversation\` DROP INDEX \`IDX_3cdae851f0b12baae5d6c715f6\``,
    )
    await queryRunner.query(
      `ALTER TABLE \`conversation\` DROP COLUMN \`avatarId\``,
    )
