...
export class MediaForComment1696935827921 implements MigrationInterface {
  name = 'MediaForComment1696935827921'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`medias\` ADD \`commentId\` int NULL`)
    await queryRunner.query(
      `ALTER TABLE \`medias\` ADD UNIQUE INDEX \`IDX_6ef8f3de55338d9d0b8ebd4f14\` (\`commentId\`)`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_6ef8f3de55338d9d0b8ebd4f14\` ON \`medias\` (\`commentId\`)`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`medias\` DROP INDEX \`IDX_6ef8f3de55338d9d0b8ebd4f14\``,
    )
    await queryRunner.query(`ALTER TABLE \`medias\` DROP COLUMN \`commentId\``)
  }
}
