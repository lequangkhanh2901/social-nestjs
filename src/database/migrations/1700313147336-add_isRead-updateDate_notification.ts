...
export class AddIsReadUpdateDateNotification1700313147336
  implements MigrationInterface
{
  name = 'AddIsReadUpdateDateNotification1700313147336'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`FK_2101227cceb4b41d216fbc0a9eb\` ON \`request_friend\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_e2fae7ed063eca039b85d3dc950\` ON \`request_friend\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_8e46da7abb99e39551c42451684\` ON \`albums\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_e2fe567ad8d305fefc918d44f50\` ON \`likes\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_ec3c75d6522fc60e0ebaf58a6b7\` ON \`likes\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_cfd8e81fac09d7339a32e57d904\` ON \`likes\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_e3aebe2bd1c53467a07109be596\` ON \`comment\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_ae05faaa55c866130abef6e1fee\` ON \`posts\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_446251f8ceb2132af01b68eb593\` ON \`message\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_7cf4a4df1f2627f72bf6231635f\` ON \`message\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_0ca422a52c318ce86181dbf01ed\` ON \`medias\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_ca0a94a1fc09f86dada24760f0f\` ON \`medias\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_43b1012f7fee059597596e8a131\` ON \`medias\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_1ced25315eb974b73391fb1c81b\` ON \`notification\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_232618d03056f5eccc093d39d42\` ON \`notification\``,
    )
    await queryRunner.query(
      `DROP INDEX \`FK_c7dc378ca2844fdfe647e00e993\` ON \`notification\``,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`notification\` ADD CONSTRAINT \`FK_c7dc378ca2844fdfe647e00e993\` FOREIGN KEY (\`postId\`) REFERENCES \`posts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX \`FK_c7dc378ca2844fdfe647e00e993\` ON \`notification\` (\`postId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_232618d03056f5eccc093d39d42\` ON \`notification\` (\`userTagetId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_1ced25315eb974b73391fb1c81b\` ON \`notification\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_43b1012f7fee059597596e8a131\` ON \`medias\` (\`messageId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_ca0a94a1fc09f86dada24760f0f\` ON \`medias\` (\`postId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_0ca422a52c318ce86181dbf01ed\` ON \`medias\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_7cf4a4df1f2627f72bf6231635f\` ON \`message\` (\`conversationId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_446251f8ceb2132af01b68eb593\` ON \`message\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_ae05faaa55c866130abef6e1fee\` ON \`posts\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_e3aebe2bd1c53467a07109be596\` ON \`comment\` (\`parentId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_cfd8e81fac09d7339a32e57d904\` ON \`likes\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_ec3c75d6522fc60e0ebaf58a6b7\` ON \`likes\` (\`commentId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_e2fe567ad8d305fefc918d44f50\` ON \`likes\` (\`postId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_8e46da7abb99e39551c42451684\` ON \`albums\` (\`userId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_e2fae7ed063eca039b85d3dc950\` ON \`request_friend\` (\`userTargetId\`)`,
    )
    await queryRunner.query(
      `CREATE INDEX \`FK_2101227cceb4b41d216fbc0a9eb\` ON \`request_friend\` (\`userId\`)`,
    )
  }
}
