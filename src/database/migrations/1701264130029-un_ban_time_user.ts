...
export class UnBanTimeUser1701264130029 implements MigrationInterface {
  name = 'UnBanTimeUser1701264130029'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`users\` ADD \`unBanTime\` datetime NULL`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`unBanTime\``)
  }
}
