...
export class CreateDateFriends1697020783433 implements MigrationInterface {
  name = 'CreateDateFriends1697020783433'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`friends\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`friends\` DROP COLUMN \`createdAt\``)
    await queryRunner.query(
