...
export class UserRequestFriend1697015496442 implements MigrationInterface {
  name = 'UserRequestFriend1697015496442'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_6ef8f3de55338d9d0b8ebd4f14\` ON \`medias\``,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_6ef8f3de55338d9d0b8ebd4f14\` ON \`medias\` (\`commentId\`)`,
    )
    await queryRunner.query(
